...
class LineDetectorHSV(dtu.Configurable, LineDetectorInterface):
    ...
    def __init__(self, configuration):
        ...
        self.hsv_white1 = np.array([0,0,155])
        self.hsv_white2 = np.array([180,70,255])
        self.hsv_yellow1 = np.array([15,125,100])
        self.hsv_yellow2 = np.array([30,255,255])
    ...
    def _colorFilter(self, color):
        ...
        #rospy.loginfo('WHITE: 1: ' + np.array2string(self.hsv_white1) + ' and 2:' + np.array2string(self.hsv_white2))
        #rospy.loginfo('YELLOW: 1: ' + np.array2string(self.hsv_yellow1) + ' and 2:' + np.array2string(self.hsv_yellow2))
